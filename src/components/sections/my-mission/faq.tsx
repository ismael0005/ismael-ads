...
import { missionFaqIntro, missionFaqs } from "@/data/my-mission";

export function MissionFaqSection() {
  return (
    <Section spacing="lg" className="relative overflow-hidden">
      <SectionHeading {...missionFaqIntro} className="mx-auto mb-14 max-w-2xl" />
