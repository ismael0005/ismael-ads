...
import { eligibilityFaqIntro, eligibilityFaqs } from "@/data/eligibility-checker";

export function EligibilityFaqSection() {
  return (
    <Section spacing="lg" className="relative overflow-hidden">
      <SectionHeading {...eligibilityFaqIntro} className="mx-auto mb-14 max-w-2xl" />
