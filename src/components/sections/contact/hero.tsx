...
import { ContactHeroStage } from "@/components/sections/contact/hero-stage";

export function ContactHero() {
  const KickerIcon = contactHero.kickerIcon;
  const [headlineLead, headlineTail] = contactHero.headline.split(contactHero.headlineEmphasis);
          ...
          >
            ...
            <div className="animate-fade-up-1">
              <Heading as="h1" size="3xl" className="mt-6 text-balance">
                {headlineLead}
                <GradientText>{contactHero.headlineEmphasis}</GradientText>
                {headlineTail}
              </Heading>
            </div>

            <p className="animate-fade-up-2 mt-6 max-w-lg text-lg text-muted-foreground">{contactHero.description}</p>
            ...
            <div className="animate-fade-up-3 mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
              <MagneticButton>
                <Button
                  ...
                  nativeButton={false}
                  render={
                    <Link href={contactHero.primaryCta.href}>
              ...
              <MagneticButton strength={0.3}>
                <Button
                  ...
                  nativeButton={false}
                  render={
                    <Link href={contactHero.secondaryCta.href}>
            ...
            <div className="animate-fade-up-4 mt-8 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm text-muted-foreground lg:justify-start">
              {contactHero.trustBadges.map((badge, index) => (
                <Fragment key={badge}>
