...
import { adFormatsFaqIntro, adFormatsFaqs } from "@/data/ad-formats";

export function AdFormatsFaqSection() {
  return (
    <Section spacing="lg" className="relative overflow-hidden">
      <SectionHeading {...adFormatsFaqIntro} className="mx-auto mb-14 max-w-2xl" />
